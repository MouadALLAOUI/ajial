...
/**
 * Dynamic PHP blueprint for safe/Robot.html.
...
$page = [
    ...
    'heading' => 'Robot',
    'greeting' => 'Bienvenue',
    'description' => 'Lists Robot visit/delivery records and provides the fields used to add a new visit. Source template: safe/Robot.html.',
    'summary' => [],
    'filters' => [],
    'form' => [
