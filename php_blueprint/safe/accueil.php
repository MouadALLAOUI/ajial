...
/**
 * Dynamic PHP blueprint for safe/Accueil.html.
...
$page = [
    'title' => 'Accueil SAFE',
    'heading' => 'Accueil SAFE',
    'greeting' => 'Bienvenue',
    'description' => 'Displays dashboard metrics and recent operational activity for the authenticated user. Source template: safe/Accueil.html.',
    'summary' => [
        [
