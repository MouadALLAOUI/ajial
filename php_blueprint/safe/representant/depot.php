...
/**
 * Dynamic PHP blueprint for safe/representant/depot.html.
...
$page = [
    ...
    'heading' => 'Depot',
    'greeting' => 'Bienvenue',
    'description' => 'Displays depot quantities and status for books or representative stock. Source template: safe/representant/depot.html.',
    'summary' => [],
    'filters' => [],
    'form' => [],
    'table' => [
