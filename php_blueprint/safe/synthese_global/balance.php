...
/**
 * Dynamic PHP blueprint for safe/Synthèse Global/Balance.html.
...
$page = [
    ...
    'heading' => 'Balance',
    'greeting' => 'Bienvenue',
    'description' => 'Displays aggregated synthesis totals using grouped SQL queries for the static summary table. Source template: safe/Synthèse Global/Balance.html.',
    'summary' => [
        [
            'label' => 'Total lignes',
