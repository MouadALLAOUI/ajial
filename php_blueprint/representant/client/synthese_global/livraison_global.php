...
require_once dirname(__DIR__, 3) . '/_shared/bootstrap.php';

/**
 * Dynamic PHP blueprint for representant/client/Synthèse Global/Livraison-global.html.
...
$page = [
    'title' => 'Livraison Global',
    'heading' => 'Livraison Global',
    'greeting' => 'Bienvenue',
    'description' => 'Displays aggregated synthesis totals using grouped SQL queries for the static summary table. Source template: representant/client/Synthèse Global/Livraison-global.html.',
    'summary' => [
        [
            'label' => 'Total lignes',
