...
function supp() {
  ...
  if (confirm('voullez vous vraiment supprimez ce livre ?')) return true;
...
function printdiv2(det) {

  var headstr = "<html><head><title></title></head><body>";

  var footstr = "</body>";

  var newstr = document.all.item(det).innerHTML;
...
function printdiv1(divID1) {
  ...
  var newstr = document.all.item(divID1).innerHTML;
